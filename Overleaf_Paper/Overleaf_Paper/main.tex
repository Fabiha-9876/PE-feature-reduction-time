...
\textbf{Generative AI Disclosure:} In accordance with IEEE policy, we disclose the use of a generative AI system in preparing this manuscript. \textit{System used:} Claude~\cite{anthropic2026claude} (Anthropic). \textit{Sections affected:} the abstract, introduction, methodology prose, results commentary, limitations, and conclusion sections were drafted or revised with AI assistance. \textit{Level of usage:} the AI system was used for prose composition and editorial revision under the authors' direction; it was not used to generate experimental designs, hypotheses, results, code, figures, or tables. All experimental results, data, source code, classifier outputs, and figures were produced, verified, and validated by the authors. The authors take full responsibility for the content of this paper, including any AI-assisted text.
...
Anthropic, ``Claude [Large language model],'' 2026. Available: \url{https://claude.ai}.
