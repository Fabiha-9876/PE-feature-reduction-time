...
# Configuration
FOLDER_PATH = "/Users/fabihajalal/Desktop/PE feature reduction time/extracted"
OUTPUT_FOLDER = "/Users/fabihajalal/Desktop/PE feature reduction time"
CSV_OUTPUT = os.path.join(OUTPUT_FOLDER, "output_file_more_features.csv")

print("=" * 60, flush=True)
print("MORE FEATURES IMPLEMENTATION (35 columns)", flush=True)
print("=" * 60, flush=True)
...
for idx, filename in enumerate(file_list):
    try:
        ...
        # Extract OPTIONAL HEADER features (27 features)
        op_header_features = {
...
print(f"Total columns: {len(df.columns)} (35 columns)", flush=True)
