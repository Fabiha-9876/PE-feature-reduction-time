...
ax1.legend()
ax1.set_ylim(0, 1.1)
ax1.set_title('Performance Metrics (More Features - 33 features)', fontweight='bold')
...
plt.suptitle('Confusion Matrices (More Features - 33 features)', fontweight='bold', y=1.02)
plt.tight_layout()
...
ax.set_title('Feature Importance - Random Forest (More Features - 33 features)', fontweight='bold')
...
ax.set_title('Accuracy Comparison (More Features - 33 features)', fontweight='bold')
...
ax.set_title('Performance Radar (More Features - 33 features)', fontweight='bold')
plt.tight_layout()
